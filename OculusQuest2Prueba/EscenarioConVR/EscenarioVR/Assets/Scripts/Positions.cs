...
public static class Positions 
{
    ...
    public static Vector3 snarePos = new Vector3(-1.954f, 2.25f, 6.89f);
    public static Vector3 sanreStandPos = new Vector3(-1.94f, 2.067f, 6.9f);

    public static Vector3 kickDrumPos = new Vector3(-1.46f, 2.00f, 7.15f);
    public static Vector3 kickDrumRot = new Vector3(-90.0f, 2.14f, -67.147f);

    public static Vector3 ftom1Pos = new Vector3(-1.199f, 2.17f, 6.66f);
    public static Vector3 ftom2Pos = new Vector3(-1.199f, 2.17f, 6.167f);
